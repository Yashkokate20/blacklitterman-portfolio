...
class BlackLittermanModel:
    ...
    def _estimate_risk_aversion(self) -> float:
        ...
        market_variance = np.dot(self.market_weights, 
                               np.dot(annual_cov, self.market_weights))
    ...
    def _compute_view_uncertainty(self, P: np.ndarray, confidence_level: str) -> np.ndarray:
        """
